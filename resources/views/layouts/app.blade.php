    ...
    <nav class="nav has-shadow " aria-label="breadcrumbs">
        <div class="container">
            ...
            <div class="nav-right" style="overflow: visible;">
                @if(Auth::guest())
                <a href="{{route('login')}}" class="nav-item is-tab is-hidden-mobile" >BROWSE EVENTS</a>
                 <a href="{{route('register')}}" class="nav-item is-tab is-hidden-mobile">LEARN MORE</a>
                 ...
                 @else
                 <button class="dropdown is-open nav-item is-tab">
