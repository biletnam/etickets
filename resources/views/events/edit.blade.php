            ...
            <div class="column is-two-thirds custom">
                ...
                <input type="hidden" name="_method" value="put" />
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input type="text" name="event_title" id="event_title" class="input" value="{{$event->event_title}}">
                        </p>
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                ...
                                <p class="control">
                                    <input type="date" class="input {{$errors->has('event_start') ? 'is-danger' : ''}}" name="event_start" id="event_start" value="{{$event->starts_at}}">
                                </p>
                                </p>
                        ...
                        <div class="column">
                            ...
                            <div class="field">
                                ...
                                <p class="control">
                                    <input type="date" class="input {{$errors->has('event_end') ? 'is-danger' : ''}}" name="event_end" id="event_end" value="{{$event->ends_at}}">
                                </p>
                                </p>
                    ...
                    <div class="field">
                        ...
                        <textarea  name="event_description" class="textarea" cols="40" placeholder="Tell People What's Special About This Event"> {{$event->event_description}}</textarea>
                        </p>
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input type="text" class="input {{$errors->has('org_name') ? 'is-danger' : ''}}" name="org_name" id="org_name"  value="{{$event->organisers_name}}" required>
                        </p>
                        </p>
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input type="text" class="input {{$errors->has('event_topic') ? 'is-danger' : ''}}" name="event_topic" id="event_topic" value="{{$event->event_topic}}">
                        </p>
                        </p>
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input type="text" class="input {{$errors->has('event_type') ? 'is-danger' : ''}}" name="event_type" id="event_type" value="{{$event->event_type}}">
                        </p>
                        </p>
